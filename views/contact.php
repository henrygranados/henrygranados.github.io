...
<link rel="icon"
      ...
      href="aa.jpg">
<head>
<center><div id="title"><h1>Software &nbsp  Developer</h1></div></center>
<hr class="fancy-line"></hr>
<div id="menu">
  <ul >
    <li> <a href="/">Home</a></li>
    <li><a href= "https://github.com/henrygranados">GitHub</a></li>
    <li><a href="/views/project.php">Projects</a></li>
    <li><a href="/assets/Resume_Henry.pdf">Resume</a></li>
    <li>  <a href="/Site/views/contact.php">Contact</a></li>
...
html {
  ...
  width: 100%;
  height: 80%;
  background-image:"assets/test.jpg";
...
#teck{
color:#62A7D9; text-shadow: black 0.2em 0.2em 0.2em;
...
#foto{
  ...
  border-radius: 60%;
  //-moz-box-shadow:3px 3px 5px 6px #5F5F61;-webkit-box-shadow: 3px 3px 5px 6px #5F5F61;box-shadow:3px 3px 5px 6px #000000;

}


.skills{
color:#039; text-shadow: white 0.2em 0.0em 0.4em;
font-family:Eurostile;  
...
hr.fancy-line { 
    ...
    background-image: -moz-linear-gradient(left, rgba(0,0,0,0), rgba(125,215,215,0.75), rgba(0,0,0,0)); 
...
#menu ul li a, #menu ul li a:hover, .button, .button:hover {
...
<body  background="/assets/test.jpg">
<div class="container">
  <form name="contactform" method="post" action="/lib/send_form_email.php">
  <table width="550px" height= "320px" style="border-radius:13px;">
  <tr>
   <td valign="top">
    <div class="fondo"><label for="name">Name</label></div>
   </td>
   <td valign="top">
  ...
  <tr>
   <td valign="top">
   <div class="fondo"> <label for="email">Email *</label></div>
   </td>
   <td valign="top">
  ...
  <tr>
   <td valign="top">
   <div class="fondo"> <label for="phone">Phone</label></div>
   </td>
   <td valign="top">
  ...
  <tr>
   <td valign="top">
    <div class="fondo"><label for="message">Message *</label></div>
   </td>
   <td valign="top">
